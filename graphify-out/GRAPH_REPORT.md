# Graph Report - BoltzUI  (2026-07-14)

## Corpus Check
- 63 files · ~87,093 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 451 nodes · 842 edges · 25 communities (11 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f7d0e92`
...
- `startJob()` --calls--> `writeJson()`  [EXTRACTED]
  server.js → lib/run-manifest.js
...
Cohesion: 0.06
Nodes (65): documentHasAtomContacts(), parseInputFile(), publicPresets(), addLog(), appendPredictOptions(), buildBoltzCommand(), { completeRunManifest, createRunManifest, writeJson }, contentType() (+57 more)
...
Cohesion: 0.06
Nodes (85): $(), api(), appendPolymerYaml(), applyParsedYamlToBuilder(), applyYamlPreset(), atomContactCard(), bindBuilderPage(), bindRepeatLists() (+77 more)
...
Cohesion: 0.07
Nodes (40): defaultOptions(), METHOD_CHOICES, normalizeOptions(), normalizeScalar(), optionSchema, presetById(), presets, resolvedPresetOptions() (+32 more)
...
## Knowledge Gaps
- **121 isolated node(s):** `fs`, `path`, `YAML`, `fsp`, `path` (+116 more)
